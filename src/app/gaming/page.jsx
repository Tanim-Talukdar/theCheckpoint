...
const games = [
  ...
  { name: "Assassin's Creed IV: Black Flag Resynced", platform: "PS5", available: true },
  { name: "Assassin's Creed Shadows", platform: "PS5", available: true },
  { name: "Astro Bot", platform: "PS5", available: false },
  { name: "Avatar: Frontiers of Pandora", platform: "PS5", available: true },
  { name: "Black Myth: Wukong", platform: "PS5", available: true },
  { name: "Borderlands 4", platform: "PS5", available: true },
  { name: "Call of Duty: Black Ops II Remake", platform: "PS5", available: true },
  ...
  { name: "Horizon Zero Dawn Remaster", platform: "PS5", available: true },
  { name: "The House of the Dead: Remake", platform: "PS5", available: true },
  ...
  { name: "Marvel's Spider-Man: Miles Morales", platform: "PS5", available: true },
  { name: "Marvel's Spider-Man", platform: "PS5", available: true },
  ...
  { name: "Naruto x Boruto: Ultimate Ninja Storm Connections", platform: "PS5", available: true },
  ...
  { name: "Resident Evil 7: Biohazard", platform: "PS5", available: true },
  ...
  { name: "Uncharted: The Nathan Drake Collection", platform: "PS5", available: true },
  { name: "Watch Dogs: Legion", platform: "PS5", available: true },
  { name: "The Witcher 3: Wild Hunt", platform: "PS5", available: true },
  { name: "Wolfenstein II: The New Colossus", platform: "PS5", available: true },
  { name: "WWE 2K26", platform: "PS5", available: true },
  { name: "Yakuza: Like a Dragon - Infinite Wealth", platform: "PS5", available: true },
  { name: "Yakuza: Like a Dragon", platform: "PS5", available: true },
  { name: "Yakuza 6: The Song of Life", platform: "PS5", available: true },
  { name: "Yakuza 0", platform: "PS5", available: true },

  // SWITCH
  { name: "The Legend of Zelda: Breath of the Wild", platform: "Switch 2", available: true },
  ...
  { name: "Hotline Miami Collection", platform: "Switch 2", available: true },
  { name: "Prince of Persia: The Lost Crown", platform: "Switch 2", available: true },
  ...
  { name: "This War of Mine: Complete Edition", platform: "Switch 2", available: true },
  { name: "Terraria", platform: "Switch 2", available: true },
  { name: "The Sker Hero Slayer", platform: "Switch 2", available: true },
  { name: "Mario Kart 8 Deluxe", platform: "Switch 2", available: true },
  { name: "FIFA 23", platform: "Switch 2", available: true },
  { name: "The House of the Dead: Remake", platform: "Switch 2", available: true },
  { name: "Scribblenauts Mega Pack", platform: "Switch 2", available: true },
  { name: "Mortal Kombat 11 Ultimate", platform: "Switch 2", available: true },
  { name: "51 Worldwide Games", platform: "Switch 2", available: true },
  { name: "Super Smash Bros. Ultimate", platform: "Switch 2", available: true },
  { name: "Brawlhalla", platform: "Switch 2", available: true },
  { name: "Immortals Fenyx Rising", platform: "Switch 2", available: true },
  { name: "Assassin's Creed: The Rebel Collection", platform: "Switch 2", available: true },
  { name: "BioShock Remastered", platform: "Switch 2", available: true },
  { name: "BioShock 2 Remastered", platform: "Switch 2", available: true },
  { name: "BioShock Infinite: The Complete Edition", platform: "Switch 2", available: true },
  ...
  { name: "Shadow of the Tomb Raider", platform: "PC", available: true },
  { name: "Life Is Strange", platform: "PC", available: true },
  { name: "The Elder Scrolls V: Skyrim", platform: "PC", available: true },
  ...
  { name: "Sleeping Dogs: Definitive Edition", platform: "PC", available: true },
  ...
  // BOARD
  { name: "Ludo", platform: "Board & Table", available: true },
  { name: "Uno", platform: "Board & Table", available: true },
  { name: "Chess", platform: "Board & Table", available: true },
  { name: "Jenga", platform: "Board & Table", available: true },
  { name: "Tic Tac Toe", platform: "Board & Table", available: true },
  { name: "Monopoly", platform: "Board & Table", available: true },
  { name: "Scrabble", platform: "Board & Table", available: true },
  { name: "Darts", platform: "Board & Table", available: true },
  { name: "Snake and Ladder", platform: "Board & Table", available: true },
  { name: "Cards Against Humanity", platform: "Board & Table", available: true },
];
...
export default function GamingPage() {
  ...
  return (
    <main className="bg-[#030712] text-white">
      ...
      <section className="relative min-h-screen overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <motion.img
            ...
            src="https://images.unsplash.com/photo-1593305841991-05c297ba4575?auto=format&fit=crop&w=2400&q=90"
        ...
        <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-10">
          ...
          >
            ...
            <p className="max-w-md text-sm leading-7 text-slate-500">
              From competitive PS5 sessions to immersive VR,
              every experience is built to make your time at
              The Checkpoint worth remembering.
            </p>
      ...
      <section
        id="games"
        className="relative overflow-hidden border-t border-white/10 bg-[#050A14] py-28 sm:py-36"
      >
          ...
          ">
            ...
            ">
              ...
              <div className="flex items-center gap-5">
                ...
                <span className="flex items-center gap-2 text-[9px] font-bold tracking-wide text-white/40">
        ...
        ">
          ...
          >
            ...
            <p className="
              ...
              text-white/40
            ">
              Grab your squad, choose your setup and
              get ready to play.
            </p>
...
function HeroStat({ icon: Icon, number, label }) {
  return (
